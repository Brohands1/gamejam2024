...
public class PlayerCharacter : MonoBehaviour
{
    ...
    void RayCastBox()
    {
        RightBox = Physics2D.BoxCastAll(Position, boxSize, 0, Vector3.right, 0.1f, playerLayerMask);
        LeftBox = Physics2D.BoxCastAll(Position, boxSize, 0, Vector3.left, 0.1f, playerLayerMask);
        UpBox = Physics2D.BoxCastAll(Position, boxSize, 0, Vector3.up, 0.05f, playerLayerMask);
        DownBox = Physics2D.BoxCast(Position, boxSize, 0, Vector3.down, 0.05f, playerLayerMask);
    }
